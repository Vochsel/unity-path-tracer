...
[ExecuteInEditMode]
public class PT_CameraManager : MonoBehaviour {
    ...
    {
        PT_CameraManager.Instance.RunShader();
    }
    ...
    void Update()
    {
        //PTGUI pgui = (PTGUI)(EditorWindow.GetWindow(typeof(PTGUI)));
        //pgui.previewTex = Camera.main.activeTexture;

        RunShader();
    }

    public static PT_CameraManager Instance;
    ...
    void RunShader()
    {
        ...
        computeShader.SetVector("camfwd", Camera.main.transform.forward);
        computeShader.SetVector("camrgt", Camera.main.transform.right);
        computeShader.SetVector("camup", Camera.main.transform.up);
        ...
        computeShader.SetFloat("camFOV", Camera.main.fieldOfView);
